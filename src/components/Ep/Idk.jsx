...
const Idk = () => {
    ...
    <div className="relative mt-20 flex h-150 w-10/10 flex-col ">
        ...
        <div className="flex h-100 w-8/10 flex-row rounded-4xl bg-white max-sm:relative max-sm:h-80 ">
            <Formik initialValues={{ gmail: "" }}>
            <Form className=" max-m:w-10/10 flex w-10/10 flex-col gap-5 rounded-4xl bg-white pt-15 dark:bg-gray-400 max-sm:absolute max-sm:h-full">
                <Field
                type="text"
                name="gmail"
                placeholder=" ایمل"
                ...
                className="max-md:ml-[0px] max-md:scale-90 ml-50 h-50 w-8/10 rounded-3xl border-2 border-gray-300 bg-white pr-5 text-right outline-0 transition-all duration-300 max-md:w-10/10 dark:border-gray-400 dark:bg-gray-800 dark:text-white max-sm:h-40"
                />
            </Form>
            </Formik>
        </div>

        <button className="bg-deep-blue absolute top-127 mt-[-50px] h-13 w-1/10 rounded-3xl font-bold text-white transition-all duration-300 max-lg:w-3/10 max-sm:w-2/10 max-sm:text-sm max-sm:top-107">
            ارسال پیام
        </button>
        </div>
