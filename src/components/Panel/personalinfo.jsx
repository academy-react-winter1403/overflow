    ...
    return (
            ...
            <div className='flex flex-row-reverse flex-wrap m-auto mt-6 w-9/10'>
                <div className='flex flex-row-reverse flex-wrap w-full h-auto justify-center max-sm:overflow-auto max-sm:h-150 max-lg:h-150 max-lg:overflow-auto'>
                    <div className='bg-white w-10/11 rounded-2xl  p-6 dark:bg-gray-700 shadow-[2px_2px_10px_1px_gray]'>
                        <div className='w-9/10 m-auto mt-10 flex flex-wrap justify-between gap-4 font-vazir'>


                            <div className='w-[48%] min-h-16 border-2 border-gray-300 rounded-xl p-4 flex items-center justify-end text-right bg-gray-50 text-sm  dark:text-white shadow-sm  dark:bg-gray-800 dark:border-gray-400/50'>
                                نام و نام خانوادگی: {profile?.fName || 'وارد نشده'} 
                            </div>

                            <div className='w-[48%] min-h-16 border-2 border-gray-300 rounded-xl p-4 flex items-center justify-end text-right bg-gray-50 text-sm font-medium dark:text-white shadow-sm  dark:bg-gray-800 dark:border-gray-400/50'>
