    ...
    return (
        <div className="relative h-85 w-9/12 flex justify-center mt-10 m-auto">
            <div className="w-6/10 flex relative">
                <div className="relative w-29/30 float-left rounded-3xl bg-white h-1/1">
                    <div className="h-9/10 mt-4 ml-7 w-7/15">
                        <div className="w-full text-4xl font-peyda text-gray-700 font-black mt-2 h-4/20 text-right">
                            {item.fullName}
                        </div>
                        <div className="w-full h-5/20 font-iransans text-2xl text-[#a7a7a7] text-right">
                            {item.linkdinProfileLink}
                        </div>
                        <div className="w-full h-5/20 flex flex-wrap row justify-center gap-2">
                            <div className="w-6/14 h-4/12 font-vazir bg-gray-200 rounded-3xl mt-1"> تعداد دوره   {item.courseCounts}
                                <img className="float-right mr-3 w-2/17 h-9/10" src={hat} alt="" />
                            </div>
                            <div className="w-6/14 h-4/12 font-vazir bg-gray-200 rounded-3xl mt-1"> 2 سال
                                <img className="float-right mr-3  w-2/17 h-9/10" src={clock} alt="" />
                            </div>
                            <div className="w-6/14 h-4/12 font-vazir bg-gray-200 rounded-3xl"> 10/10
                                <img className="float-right mr-3 w-2/17 h-9/10" src={star} alt="" />
                            </div>
                            <div className="w-6/14 h-4/12  font-vazir bg-gray-200 rounded-3xl">تعداد اخبار   {item.newsCount}
                                <img className="float-right mr-3 w-2/17 h-9/10" src={hat} alt="" />
                            </div>
                        </div>
