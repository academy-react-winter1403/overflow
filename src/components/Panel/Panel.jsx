...
const Panel = () => {
  return (
    <div className="flex flex-row-reverse flex-wrap w-10/10 border-2 bg-gray-100 ">
                            {/* right panel */}
        ...
        <div className='flex flex-row-reverse flex-wrap w-7/10  border-2'>
                            {/* top side */}
            <div className='flex flex-row-reverse w-10/10 text-3xl h-15'>
            ...
            <div className='flex flex-row-reverse w-10/10 h-auto bg-red-200 justify-center gap-8 mt-[-250px]'>
