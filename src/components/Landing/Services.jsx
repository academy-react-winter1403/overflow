    ...
    <div className="container mx-auto py-10">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <button className="text-blue-500 hover:underline">مشاهده همه اخبار</button>
          ...
          <div key={newsItem.id} className="bg-white shadow-lg rounded-lg p-6">
            <div className="flex justify-between items-center">
              <div className="w-full md:w-1/2">
                <h3 className="text-xl font-semibold text-gray-700 mb-4">{newsItem.title}</h3>
                <p className="text-sm text-gray-600 mb-6">
                  {newsItem.miniDescribe}
                </p>
                <button className="bg-blue-500 text-white py-2 px-4 rounded-md">مشاهده بیشتر</button>
              </div>
              <div className="w-full md:w-1/2 flex justify-center">
                <img
                  src={newsItem.currentImageAddressTumb || "/path-to-your-default-image.jpeg"} // Fallback to default image if no image URL
                  alt={newsItem.title}
