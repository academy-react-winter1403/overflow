...
const Mynewssetcomment = () => {
  ...
  return (
    <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-4 max-h-96 overflow-y-auto m-auto mt-10">
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-6 space-y-4">
        <h2 className="text-2xl font-semibold text-center text-indigo-600 mb-4">نظرات خبری من</h2>
        {loading ? (
