      ...
      <div className="font-kalameh flex justify-center gap-10 px-6 py-8  font-semibold text-gray-700 dark:text-gray-300">
        <div className={`flex ${similarNews.length==0? "max-w-8/10" : "max-w-6/10"} max-md: flex-col items-center`}>
          <div className="flex w-full flex-col items-center space-y-6 lg:space-y-0">
            ...
            <header className="w-full p-8 text-right text-gray-700 dark:text-gray-300">
        ...
        {similarNews.length > 0 ? (
          <div className="max-md:hidden shadow-deep-blue relative h-[500px] w-2/10 rounded-3xl shadow-lg dark:shadow-gray-700">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-row-reverse items-center justify-center px-2 text-right">
                      <h3 className="font-peyda h-17 max-xl:hidden overflow-clip px-2 text-2xl font-bold break-all text-gray-600 dark:text-gray-300">
                        {news.title}
                      </h3>
                    </div>
                  </div>
