...
function Card({ item, index, handleNavigation, className = "" }) {
  ...
  return (
    <div className={`${className} pt-15`}>
      <div
        className="relative h-140 w-96 cursor-pointer rounded-[29px] bg-white px-6 text-right shadow-lg transition-all max-2xl:h-126 max-2xl:w-80 dark:bg-gray-400/95"
        key={index}
