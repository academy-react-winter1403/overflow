...
const NewsDetails = () => {
  ...
  const news = {
    ...
    date: "July 20, 2024",
    content: "Here’s a quick overview of how you can improve self-awareness in just 20 minutes. We dive into some techniques and exercises that are scientifically proven to boost mindfulness and personal clarity.",
    author: "Jessica Rose",
  };
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <header className="text-center mb-6">
        ...
        <div className="text-lg text-gray-600">{news.date} | {news.author}</div>
      </header>

      <div className="mb-6">
        <img src="path_to_your_image.jpg" alt="news cover" className="w-full h-80 object-cover rounded-xl shadow-lg mb-4" />
        ...
        <section>
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-4">
              <img src="path_to_related_image.jpg" alt="Related post" className="w-16 h-16 object-cover rounded-full" />
              <div>
                <p className="text-md font-medium text-gray-800">Make Your Own Expanding</p>
