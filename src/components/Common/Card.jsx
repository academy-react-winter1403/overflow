...
function Card({ item, index, handleNavigation, className = "" }) {
  ...
  return (
    <div className={`${className} pt-15`}>
      <div
        className="relative h-140 w-96 cursor-pointer rounded-[29px] bg-white px-6 text-right shadow-lg transition-all max-2xl:h-126 max-2xl:w-80 max-lg:w-100 max-md:w-80 dark:bg-gray-400/95"
        key={index}
      ...
      >
        <div className="relative h-[200px] max-2xl:h-45">
          <img
            ...
            alt={item.title}
            className="shadow-deep-blue absolute -top-15 h-[223px] w-[340px] rounded-3xl object-cover shadow-lg"
          />
        </div>
        ...
        <div className="text-right">
          ...
          <div className="font-kalameh-num flex flex-row-reverse justify-between o">
            ...
            <span className="text-deep-blue relative flex w-auto max-w-5/7  flex-wrap  justify-center gap-1 truncate text-2xl font-bold">
